...
/**
 * ViewCustomizationUser component for user dashboard view customization
 * @returns {JSX.Element} ViewCustomizationUser component
 */
const ViewCustomizationUser = () => {
    ...
    return (
      <>
            ...
            {elements.map(element => (
              ...
              >
                <ElementCheckbox 
                  ...
                  onChange={() => {}} // Kontrolowany przez onClick na ElementItem
                />
                <ElementInfo>
        ...
        <ButtonGroup>
          {editMode ? (
            <>
              <Button primary onClick={handleUpdateView} disabled={isSubmitting}>
                Zapisz zmiany
              </Button>
            ...
            <Button primary onClick={handleCreateView} disabled={isSubmitting}>
              Utwórz widok
            </Button>
          )}
        </ButtonGroup>
  ...
  return (
    <PageContainer>
      <SectionTitle>PERSONALIZACJA WIDOKU</SectionTitle>
      ...
      <TabsContainer>
        ...
        <Tab 
          active={activeTab === 'createView' || (editMode && activeTab === 'editView')} 
          onClick={() => {
        ...
        >
          {editMode ? 'Edytuj widok' : 'Utwórz nowy widok'}
        </Tab>
      </TabsContainer>
      
      <Card fullWidth>
        {activeTab === 'myViews' && renderViews()}
        {(activeTab === 'createView' || activeTab === 'editView') && renderViewForm()}
      </Card>
    </PageContainer>
  );
};
