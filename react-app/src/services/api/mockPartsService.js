  ...
  async getSupplierDetails(id) {
    ...
    const suppliers = {
      ...
      'SUP-003': {
        ...
        notes: 'Dobra jakość części, czasami opóźnienia w dostawach.',
        orderHistory: [
          {
            date: '2025-03-15',
            orderId: 'ORD-003',
      ...
      'SUP-004': {
        ...
        email: 't.muller@sachs.com',
        phone: '+49 345 678 901',
        address: 'Ernst-Sachs-Straße 62, 97424 Schweinfurt, Niemcy',
        ...
        notes: 'Specjalizacja w częściach zawieszenia.',
        orderHistory: [
          {
            date: '2025-03-10',
            orderId: 'ORD-004',
      ...
      'SUP-005': {
        ...
        categories: ['Paski napędowe', 'Opony', 'Elektronika'],
        rating: 4.6,
        performance: {
          timeliness: 4.8,
          quality: 4.7,
        ...
        notes: 'Wysoka jakość produktów, szybkie dostawy.',
        orderHistory: [
          {
            date: '2025-03-01',
            orderId: 'ORD-006',
...
export const mockPartsService = new MockPartsService();
