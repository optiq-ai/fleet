...
/**
 * @typedef {Object} TransactionPatternAnalysisProps
 * @property {Array} transactions - List of transactions to analyze
 * @property {Function} onAnomalyDetected - Callback when anomalies are detected
 */
...
/**
 * Transaction pattern analysis component for fraud detection
 * @param {TransactionPatternAnalysisProps} props - Component props
 * @returns {JSX.Element} TransactionPatternAnalysis component
 */
const TransactionPatternAnalysis = ({ 
  ...
  // Wykrywanie anomalii
  const detectAnomalies = (patterns) => {
    return patterns
