...
interface CardPresenceVerificationProps {
  results: any;
  onClose: () => void;
}
...
const DetailValue = styled.div<{ highlight?: boolean; success?: boolean }>`
...
const CardPresenceVerification: React.FC<CardPresenceVerificationProps> = ({ 
  results, 
  onClose 
}) => {
