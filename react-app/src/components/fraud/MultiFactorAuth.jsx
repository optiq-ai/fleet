...
/**
 * @typedef {Object} MultiFactorAuthProps
 * @property {Function} onVerify - Callback when verification is complete
 ...
 * @param {MultiFactorAuthProps} props - Component props
 * @returns {JSX.Element} MultiFactorAuth component
 */
