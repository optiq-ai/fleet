...
/**
 * @typedef {Object} BlockchainLedgerProps
 * @property {Array} transactions - List of transactions to verify
 * @property {Function} onLedgerVerified - Callback when ledger verification status changes
 */
...
/**
 * Blockchain ledger component for fraud detection
 * @param {BlockchainLedgerProps} props - Component props
 * @returns {JSX.Element} BlockchainLedger component
 */
