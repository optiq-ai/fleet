...
/**
 * @typedef {Object} BiometricAuthModalProps
 * @property {Object} transaction - Transaction details
 * @property {Function} onClose - Function to close the modal
 * @property {Function} onAuthenticate - Function to handle authentication result
 */
...
/**
 * Biometric authentication modal component
 * @param {BiometricAuthModalProps} props - Component props
 * @returns {JSX.Element} BiometricAuthModal component
 */
