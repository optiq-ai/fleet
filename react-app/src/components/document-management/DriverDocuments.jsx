...
const DriverDocuments = ({ 
  ...
  if (isLoading) {
    return <LoadingMessage>Loading driver documents...</LoadingMessage>;
  }
    ...
    <Container>
      ...
      <FiltersContainer>
        ...
        <SearchContainer>
          ...
          <SearchInput 
            type="text" 
            placeholder="Search driver documents..." 
      ...
      {documents.length > 0 ? (
        ...
        <EmptyMessage>
          No driver documents found. Try adjusting your filters or upload a new document.
        </EmptyMessage>
      )}
