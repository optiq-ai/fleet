...
const OperationalDocuments = ({ 
  ...
  if (isLoading) {
    return <LoadingMessage>Loading operational documents...</LoadingMessage>;
  }
  ...
  return (
    <Container>
      <Header>
        <Title>Operational Documents</Title>
        <Actions>
      ...
      {documents.length > 0 ? (
        ...
        <EmptyMessage>
          No operational documents found. Try adjusting your filters or upload a new document.
        </EmptyMessage>
      )}
