...
const VehicleDocuments = ({ 
  ...
  if (isLoading) {
    return <LoadingMessage>Loading vehicle documents...</LoadingMessage>;
  }
    ...
    <Container>
      ...
      <FiltersContainer>
        ...
        <SearchContainer>
          ...
          <SearchInput 
            type="text" 
            placeholder="Search vehicle documents..." 
      ...
      {documents.length > 0 ? (
        ...
        <EmptyMessage>
          No vehicle documents found. Try adjusting your filters or upload a new document.
        </EmptyMessage>
      )}
